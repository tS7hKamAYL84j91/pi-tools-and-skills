...
const BUILTIN_IDS = ["deep-research", "fusion-analysis", "llm-council", "navigator", "router-fusion"];
...
describe("projectBuiltinTeams", () => {
	...
	it("does not overwrite an existing user file (preexisting edit preserved)", async () => {
		...
		expect([...result.projected].sort()).toEqual(["deep-research", "fusion-analysis", "llm-council", "router-fusion"]);
