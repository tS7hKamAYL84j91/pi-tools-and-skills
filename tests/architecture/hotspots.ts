...
const COUPLING_BUDGETS: CouplingBudget[] = [
	...
	{
		modules: ["coas", "coas-tools"],
		maxCommits90d: 12,
		reason: "tools.ts is part of the coas extension; factory refactor split registrations into the same extension file, increasing commits tagged against both modules. Decoupling plan target 2026-09-22: keep tools.ts as the single coas tool surface; no new cross-module calls.",
	...
	},
	{
		modules: ["goal", "kanban"],
		maxCommits90d: 5,
		reason: "One-time package metadata alignment (engines.node) across lifecycle and task extensions. Decoupling plan target 2026-09-22: no shared runtime surface; manifests remain independent.",
		createdAt: "2026-07-11",
		targetDate: "2026-09-22",
	},
	{
		modules: ["kanban", "lib"],
		maxCommits90d: 5,
		reason: "One-time package metadata alignment (engines.node) and shared test helper changes touched kanban and lib. Decoupling plan target 2026-09-22: limit kanban/lib shared surface to already-extracted helpers; no new runtime coupling.",
		createdAt: "2026-07-11",
		targetDate: "2026-09-22",
	},
];
