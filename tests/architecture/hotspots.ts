...
const COUPLING_BUDGETS: CouplingBudget[] = [
	...
	},
	{
		modules: ["goal", "lib"],
		maxCommits90d: 7,
		reason: "T-797/T-821 introduced shared lib/gate-command.ts and durable goal state helpers used by goal. Decoupling plan target 2026-09-22: goal relies on lib helpers only; no lib imports from goal.",
		createdAt: "2026-07-11",
		targetDate: "2026-09-22",
	},
	{
		modules: ["kanban", "lib"],
		maxCommits90d: 10,
		reason: "T-802/T-821 introduced shared lib/gate-command.ts used by kanban completion gate, plus package metadata alignment and recent refactor commits touching kanban helpers and lib transports. Decoupling plan target 2026-09-22: limit kanban/lib shared surface to lib/gate-command.ts and already-extracted helpers; no new runtime coupling.",
		createdAt: "2026-07-11",
		targetDate: "2026-09-22",
	},
];
