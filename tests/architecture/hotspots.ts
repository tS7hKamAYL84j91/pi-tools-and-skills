...
const COUPLING_BUDGETS: CouplingBudget[] = [
	...
	},
	{
		modules: ["kanban", "lib"],
		maxCommits90d: 6,
		reason: "T-802/T-821 introduced shared lib/gate-command.ts used by kanban completion gate, plus package metadata alignment. Decoupling plan target 2026-09-22: limit kanban/lib shared surface to lib/gate-command.ts and already-extracted helpers; no new runtime coupling.",
		createdAt: "2026-07-11",
		targetDate: "2026-09-22",
	},
];
