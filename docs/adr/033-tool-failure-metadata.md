...
3. **Targeted Adoption**: We will gradually adopt these fields at complex external or destructive boundaries (such as agent spawning in Panopticon or scheduling in Automations) without breaking existing caller mechanics.
