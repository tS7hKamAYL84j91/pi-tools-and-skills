# ADR 1: Automations Extension UX Error Handling Pattern
...
The pi-automations extension tools threw raw `Error` for user-correctable failures
...
Read-only tools with no parameters (automations_status, automations_doctor, workspace_list,
