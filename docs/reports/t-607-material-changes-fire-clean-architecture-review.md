...
- Panopticon memory evidence: ADR 022, `docs/reports/t-595-panopticon-memory-renderer-poc.md`, `docs/reports/t-597-panopticon-memory-reader-design.md`, `extensions/pi-panopticon/ui/memory-renderer.ts`, `tests/panopticon-memory-renderer.test.ts`.
...
| pi-teams runtime hardening | `6325e7f`, `a722106`, `aeddb76`, `f5ff48f`, `31f2ff0`; `extensions/pi-panopticon/teams/*`, team tests | Fallback semantics, state/detail tests, handoff routing validation, and worktree isolation POC were added. T-316 found merge-ready with follow-ups. | **PASS** under internal/provisional boundaries. |
