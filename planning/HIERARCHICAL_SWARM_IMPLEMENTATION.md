...
- Define manifest role templates and hierarchical bounds.
...
- Root/sub-manager spawn logic with inherited depth, total-node, child, WIP, TTL, model-safety, and write-isolation budgets.
...
- No child can exceed inherited capacity.
