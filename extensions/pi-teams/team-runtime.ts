...
const TeamFormSchema = Type.Object({
	...
	protocol: Type.Union([Type.Literal("consult"), Type.Literal("debate"), Type.Literal("research"), Type.Literal("hierarchical-swarm")], { description: "Team protocol for generated team files." }),
