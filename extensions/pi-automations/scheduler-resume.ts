...
export interface ResumeContext {
	pi: ExtensionAPI;
	config: AutomationsConfig | undefined;
...
export async function resumeApprovedRunTracked(ctx: ResumeContext, config: AutomationsConfig, requestId: string): Promise<boolean> {
