/** Automations workspace CONTEXT.md read, append, and compaction helpers. */

import { withFileMutationQueue } from "@earendil-works/pi-coding-agent";
import { dirname, join } from "node:path";
import { isoUtc } from "./store-paths.js";
import { resolveWorkspace } from "./workspace-paths.js";
import type { AutomationsConfig, WorkspaceReadOptions } from "./types.js";
...
async function compactContextIfNeeded(
	...
	const compact = [
		"# Automations Workspace Context (SPR)",
		"",
		`- Compacted: ${stamp}`,
